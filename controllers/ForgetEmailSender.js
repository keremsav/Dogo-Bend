  ...
  <center>
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable" style="height:100% ;margin:0;padding:0;width:100% ;background-color:#FAFAFA;">
      <tr>
        ...
        console.log('Verification email sent. ', sentMail.messageId)
...
module.exports.sendResetMail = async (Email,verificationToken) => {
    try {
        let transporter = nodemailer.createTransport({
            service : 'gmail',
            auth : {
...
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <!-- Facebook sharing information tags -->
  <meta property="og:title" content="Reset Your Email">
  <title>Verify Your Email</title>
  <style type="text/css">
    #outlook a{
        padding:0;
  ...
  <center>
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable" style="height:100% ;margin:0;padding:0;width:100% ;background-color:#FAFAFA;">
      <tr>
        ...
        const sentMail = await transporter.sendMail(mailOptions);
        console.log('Reset email sent.', sentMail.messageId);
